...
describe('Property 4: Zone_Colors preservation with traceability indicator', () => {
    it('los colores de zona son independientes de specStatus y specHealthScore', () => {
        // Generadores
        const pathArb = fc.oneof(fc.constant('packages/frontend/src/App.tsx'), fc.constant('packages/backend/src/app.ts'), fc.constant('shared/utils/helpers.ts'), fc.constant('.eslintrc.json'), fc.constant('packages/frontend/src/components/module_panel.tsx'), fc.constant('packages/backend/src/routes/analyze.ts'), fc.constant('lib/common/types.ts'), fc.constant('config/settings.yaml'), fc.constant('unknown/path/file.go'), fc.constant('packages/frontend/public/index.html'), fc.constant('src/services/api.ts'), fc.constant('templates/main.astro'));
        ...
        fc.assert(fc.property(pathArb, specStatusArb, scoreArb, (path, _specStatus, _specHealthScore) => {
